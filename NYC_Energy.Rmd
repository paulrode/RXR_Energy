...
monthlyELectNoCovid %>% ggplot()) +
  geom_line(aes(x = date, y = cdd))
  
  
  
  geom_rect(aes(xmin = date[1], ymin = 0, xmax = date[length(monthlyELectNoCovid$date) ], ymax = min(monthlyElect[-1,]$kWh)), color = "blue", fill = "blue", alpha = 0.01)
