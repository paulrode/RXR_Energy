...
alldata_perday %>% mutate(mean(Elect61[Elect61BWay > Elect61$`Start Date`& Elect61BWay < Elect61$`End Date`, 6])) -> alldata_perday

Elect61[Elect61BWay > Elect61$`Start Date`& Elect61BWay < Elect61$`End Date`]
