...
annualdata %>% filter(`Meter Type` == "Electric" & Year > 2016 & Year < 2020) %>% ggplot(aes(x = Year, y = Consumpton))+ geom_line()+ theme(axis.text.x = element_text(angle = 90)) + facet_wrap(~Building)

annualdata %>% filter(`Meter Type` == "Electric" & Year > 2016 & Year < 2020) %>% ggplot(aes(x = Year, y = Consumpton))+ geom_col(position = "dodge", fill="red")+ theme(axis.text.x = element_text(angle = 90)) + facet_wrap(~Building)
...
annualdata %>% filter(`Meter Type` == "Electric" & Year > 2016 & Year < 2020) %>% ggplot(aes(x = Month, y = Consumpton))+ geom_col(position = "dodge", Year = fill)+ theme(axis.text.x = element_text(angle = 90)) + facet_wrap(~Building)
