...
read_csv("C:/Users/paulr/Documents/230ParkEnergy/data/230 Park Avenue Total Building Electric (Curtailment).csv", col_names = TRUE) %>% select(c(1:2)) -> ies_elect_data
